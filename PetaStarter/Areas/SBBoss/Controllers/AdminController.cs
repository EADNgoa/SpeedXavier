...
namespace Speedbird.Areas.SBBoss.Controllers
{
    ...
    public class AdminController : EAController
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.DriversEndingInsurance = db.Query<DriversEndingInsurance>("select d.DriverId, d.DriverName,c.CarBrand,c.Model,PlateNo,c.InsuranceCompany,c.InsuranceEndDate " +
